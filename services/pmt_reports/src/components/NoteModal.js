  ...
  render() {
    ...
    return (
      <Modal isOpen={this.props.isOpen} toggle={this.openClose}>
        <ModalHeader toggle={this.openClose}>Selection Notes</ModalHeader>
        <ModalBody>
          ...
          <Form>
            ...
            <FormGroup>
              <Label for="justification">
                What is your rationale for selecting this course?
              </Label>
              <Input
                type="textarea"
                name="text"
        ...
        <ModalFooter>
          <Button className="btn-sm" color="secondary" onClick={this.openClose}>
            Close
          </Button>
          <Button
            className="btn-sm"
